...
void exec(list<char> &main_list) {
    ...
    // cout<<"P_DE_EX.rd = "<<P_DE_EX.rd<<" inst_type "<<P_DE_EX.inst_type<<endl;
    // cout<<"P_EX_MA.rd = "<<P_EX_MA.rd<<" inst_type "<<P_EX_MA.inst_type<<endl;
    // cout<<"P_MA_wb.rd = "<<P_MA_WB.rd<<" inst_type "<<P_MA_WB.inst_type<<endl;
}
...
void decode(){
    ...
    if (check_dep(P_IF_DE.inst, P_DE_EX.inst) && P_DE_EX.nop==0) {
        RAW_dep=3;
    ...
    } else if (check_dep(P_IF_DE.inst, P_MA_WB.inst) && P_MA_WB.nop==0) {
        RAW_dep=1;
    ...
    cout<<"func3 : "<<func3<<" func7 : "<<func7<<endl;
        ...
        cout<<"... STALL ... DECODE ... "<<P_IF_DE.instruction<<'\n';
    }
...
void execute(){
    ...
    isBranchTaken=0;
        ...
        cout<<"... STALL ... EXECUTE ... "<<P_DE_EX.instruction<<'\n';
    }
...
void memory(){
    ...
    cout<<'\n';
        ...
        cout<<"... STALL ... MEMORY ... "<<P_EX_MA.instruction<<'\n';
    }
